...
//wall
    ...
    function setlocationstuff(){
        $("#space70").data("castle",true).data("move1",'27').data("move2",'28').data("move3",'').data("move4",'').data("left",260).data("top",280).data("location",70);
        
        $("#space1").data("move1",'2').data("move2",'8').data("move3",'7').data("move4",'35').data("left",125).data("top",115).data("location",1).data("fortify",false);
        $("#space2").data("move1",'35').data("move2",'1').data("move3",'36').data("move4",'3').data("left",75).data("top",170).data("location",2).data("fortify",false);
        $("#space3").data("move1",'2').data("move2",'36').data("move3",'8').data("move4",'9').data("left",120).data("top",230).data("location",3).data("fortify",false);
        $("#space4").data("move1",'38').data("move2",'6').data("move3",'10').data("move4",'').data("left",125).data("top",510).data("location",4).data("fortify",false);
        $("#space5").data("move1",'37').data("move2",'11').data("move3",'6').data("move4",'').data("left",120).data("top",380).data("location",5).data("fortify",false);
        $("#space6").data("move1",'5').data("move2",'12').data("move3",'4').data("move4",'').data("left",130).data("top",450).data("location",6).data("fortify",false);
        $("#space7").data("move1",'8').data("move2",'1').data("move3",'30').data("move4",'').data("left",205).data("top",115).data("location",7).data("fortify",false);
        $("#space8").data("move1",'1').data("move2",'7').data("move3",'3').data("move4",'9').data("left",170).data("top",170).data("location",8).data("fortify",false);
        $("#space9").data("move1",'8').data("move2",'3').data("move3",'27').data("move4",'').data("left",210).data("top",230).data("location",9).data("fortify",false);
        $("#space10").data("move1",'12').data("move2",'4').data("move3",'26').data("move4",'').data("left",215).data("top",510).data("location",10).data("fortify",false);

        $("#space11").data("move1",'5').data("move2",'28').data("move3",'12').data("move4",'').data("left",210).data("top",380).data("location",11).data("fortify",false);
        $("#space12").data("move1",'6').data("move2",'11').data("move3",'25').data("move4",'26').data("left",210).data("top",450).data("location",12).data("fortify",false);
        $("#space13").data("move1",'30').data("move2",'29').data("move3",'14').data("move4",'19').data("left",355).data("top",115).data("location",13).data("fortify",false);
        $("#space14").data("move1",'13').data("move2",'19').data("move3",'15').data("move4",'21').data("left",410).data("top",170).data("location",14).data("fortify",false).data("castle",true).data("color",'red');
        $("#space15").data("move1",'27').data("move2",'21').data("move3",'14').data("move4",'').data("left",370).data("top",230).data("location",15).data("fortify",false);
        $("#space16").data("move1",'26').data("move2",'18').data("move3",'22').data("move4",'').data("left",365).data("top",510).data("location",16).data("fortify",false);
        $("#space17").data("move1",'28').data("move2",'23').data("move3",'18').data("move4",'').data("left",360).data("top",380).data("location",17).data("fortify",false);
        $("#space18").data("move1",'25').data("move2",'17').data("move3",'24').data("move4",'16').data("left",360).data("top",380).data("location",18).data("fortify",false);
        $("#space19").data("move1",'13').data("move2",'14').data("move3",'20').data("move4",'31').data("left",445).data("top",115).data("location",19).data("fortify",false);
        $("#space20").data("move1",'19').data("move2",'31').data("move3",'21').data("move4",'32').data("left",500).data("top",170).data("location",20).data("fortify",false);
        $("#space21").data("move1",'14').data("move2",'15').data("move3",'20').data("move4",'32').data("left",460).data("top",230).data("location",21).data("fortify",false);
        $("#space22").data("move1",'16').data("move2",'24').data("move3",'34').data("move4",'').data("left",450).data("top",510).data("location",22).data("fortify",false);
        $("#space23").data("move1",'17').data("move2",'33').data("move3",'24').data("move4",'').data("left",450).data("top",380).data("location",23).data("fortify",false);
        $("#space24").data("move1",'23').data("move2",'18').data("move3",'22').data("move4",'').data("left",450).data("top",450).data("location",24).data("fortify",false);
        $("#space25").data("move1",'12').data("move2",'28').data("move3",'18').data("move4",'26').data("left",295).data("top",450).data("location",25).data("fortify",false);
        
        $("#space26").data("move1",'25').data("move2",'10').data("move3",'16').data("move4",'').data("left",295).data("top",510).data("location",26).data("fortify",false);
        $("#space27").data("move1",'9').data("move2",'29').data("move3",'15').data("move4",'70').data("left",290).data("top",230).data("location",27).data("fortify",false);
        $("#space28").data("move1",'11').data("move2",'17').data("move3",'25').data("move4",'70').data("left",290).data("top",380).data("location",28).data("fortify",false);
        $("#space29").data("move1",'30').data("move2",'27').data("move3",'').data("move4",'').data("left",290).data("top",170).data("location",29).data("fortify",false);
        $("#space30").data("move1",'7').data("move2",'13').data("move3",'29').data("move4",'').data("left",280).data("top",115).data("location",30).data("fortify",false);
        $("#space31").data("move1",'19').data("move2",'20').data("move3",'').data("move4",'').data("left",535).data("top",115).data("location",31).data("fortify",false);
        $("#space32").data("move1",'21').data("move2",'20').data("move3",'').data("move4",'').data("left",535).data("top",230).data("location",32).data("fortify",false);
        $("#space33").data("move1",'23').data("move2",'').data("move3",'').data("move4",'').data("left",535).data("top",380).data("location",33).data("fortify",false);
        $("#space34").data("move1",'22').data("move2",'').data("move3",'').data("move4",'').data("left",535).data("top",510).data("location",34).data("fortify",false);
        $("#space35").data("move1",'1').data("move2",'2').data("move3",'').data("move4",'').data("left",50).data("top",115).data("location",35).data("fortify",false);
        $("#space36").data("move1",'2').data("move2",'3').data("move3",'').data("move4",'').data("left",50).data("top",230).data("location",36).data("fortify",false);
        $("#space37").data("move1",'5').data("move2",'').data("move3",'').data("move4",'').data("left",50).data("top",380).data("location",37).data("fortify",false);
        $("#space38").data("move1",'4').data("move2",'').data("move3",'').data("move4",'').data("left",50).data("top",510).data("location",38).data("fortify",false);
    }
...
function updateHeader(){
           $('#top').html("<div style='margin-top:15px; margin-left:10px'><span>Turn:" + day + "/50</span><span style=''><img style='margin-top:-10px; margin-left:15px' src='../Pictures/Enemies/wolf.gif' />: " + wolves + "/" + wolflimit +"</span>"+
                             "<span style='margin-left:5px'><img src='../Pictures/Enemies/Sparrow.gif' />: " + sparrows + "/" + sparrowlimit +"</span>"+
                             "<span style='margin-left:5px'><img src='../Pictures/Enemies/spider.gif' />: " + spiders + "/" + spiderlimit +"</span>"+
                             "<span style='margin-left:5px'><img src='../Pictures/Enemies/bear.gif' />: " + bears + "/" + bearlimit +"</span>"+
                             "<span style='margin-left:5px'><img src='../Pictures/Enemies/Elk.gif' />: " + elk + "/" + elklimit +"</span>"+
                             "<span style='margin-left:5px'><img src='../Pictures/Enemies/Turtle.gif' />: " + turtles + "/" + turtlelimit +"</span></div>");
}
...
saving("10")
 ...
 bearlimit=1+difflevel;
 spiderlimit=1+difflevel;
 elklimit=2+(2*difflevel);
 turtlelimit=1+difflevel;
